...
(function() {
  ...
  describe('Operations for version 1.2 spec', function() {
    ...
    return describe("resolves relative urls", function() {
      var args, stub;
      args = {};
      stub = {
        pathJson: function() {
      ...
      it("resolves protocol-relative URLs", function() {
        ...
        return expect(url).toBe("" + window.location.protocol + stub.resource.basePath);
      });
      return it("resolves root-relative URLs", function() {
        var url;
        stub.resource.basePath = "/foo";
        url = SwaggerOperation.prototype.urlify.call(stub, args);
        return expect(url).toBe("" + window.location.protocol + "//" + window.location.host + stub.resource.basePath);
      });
    });
  });
