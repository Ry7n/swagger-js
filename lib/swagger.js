...
(function() {
  ...
  SwaggerOperation = (function() {
    ...
    SwaggerOperation.prototype.urlify = function(args) {
      var loc, param, queryParams, reg, url, _i, _j, _len, _len1, _ref, _ref1;
      ...
      if (url.indexOf("/") === 0 && typeof window !== 'undefined' && window.location) {
        loc = window.location;
        url = url.indexOf("//") === 0 ? "" + loc.protocol + url : "" + loc.protocol + "//" + loc.host + url;
      }
      return url;
    };
